          ...
          <div className="bd-content">
            ...
            <div className="bd-content-wrapper">
              ...
              <div className="content-1">
                ...
                <div className="content-detail">
                  <p>
                    Kết quả test nhanh âm tính với kháng nguyên bề mặt của siêu
                    vi B
                  </p>
                </div>
              </div>
              <div className="content-1">
                ...
                <div className="content-detail">
                  <p>
                    Thời gian tối thiểu giữa 2 lần hiến máu là 12 tuần đối với
                    cả Nam và Nữ
                  </p>
                </div>
                <div className="content-detail">
                ...
                <div className="bottom-left">
                  <div className="flip-card-inner">
                    ...
                    <div className="content-back">
                      ...
                      <ul>
                        <li>
                          Đêm trước hiến máu không nên thức quá khuya (ngủ ít
                          nhất 6 tiếng).
                        </li>
                        <li>
                  ...
                  <div className="flip-card-inner">
                    ...
                    <div className="content-back">
                      ...
                      <ul>
                        ...
                        <li>
                          Nếu vết băng cầm máu chảy máu, hãy nâng tay lên, ấn
                          nhẹ vào vết bông, ngồi xuống và báo nhân viên y tế hỗ
                          trợ.
                        </li>
                      </ul>
                    </div>
